...
export default endpoint({ nocache: true })
    .SecureGet(EUserRolePermission.everyone, routes.location.GET).addHandler(async (req: Request, res: Response) =>
    {
    ...
    .SecurePost(EUserRolePermission.manage_all_locations, routes.location.POST).addHandler(async (req: Request, res: Response) =>
    {
        const token = res.locals.accessToken!
    ...
    .SecureGet(EUserRolePermission.everyone, routes.location._locationId_.GET).addHandler(async (req: Request, res: Response) =>
    {
        const token      = res.locals.accessToken!
    ...
    .SecureGet(EUserRolePermission.everyone, routes.location._locationId_.users.GET).addHandler(async (req: Request, res: Response) =>
    {
        const token      = res.locals.accessToken!
        const locationId = Number.parseInt(req.params.locationId)
    ...
    .SecureGet(EUserRolePermission.everyone, routes.location._locationId_.leaders.GET).addHandler(async (req: Request, res: Response) =>
    {
        const token      = res.locals.accessToken!
        const locationId = Number.parseInt(req.params.locationId)
