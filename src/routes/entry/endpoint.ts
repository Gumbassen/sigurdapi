...
export default messages(entry(endpoint({ nocache: true })
    .SecurePost(EUserRolePermission.create_own_entries, routes.entry.POST).addHandler(async (req: Request, res: Response) =>
    {
